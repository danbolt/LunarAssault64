...
void generateLowDetailDLPerSection(SectionData* section, int originX, int originY) {
  ...
  *(verts++) = (Vtx){(originX) -   50, (originY) -   50, heightA, 0, ((texIndex % 4) * 8) << 6,     (((texIndex / 4) % 4) * 8) << 6, 0x11, (u8)(0xff * heightA / 2000.f), 0x13, 0xff };
  *(verts++) = (Vtx){(originX) + 450, (originY) -   50, heightB, 0, ((texIndex % 4) * 8 + 7) << 6, (((texIndex / 4) % 4) * 8) << 6, 0x11, (u8)(0xff * heightB / 2000.f), 0x13, 0xff };
  *(verts++) = (Vtx){(originX) + 450, (originY) + 450, heightC, 0, ((texIndex % 4) * 8 + 7) << 6, (((texIndex / 4) % 4) * 8 + 7) << 6, 0x11, (u8)(0xff * heightC / 2000.f), 0x13, 0xff };
  *(verts++) = (Vtx){(originX) -   50, (originY) + 450, heightD, 0, ((texIndex % 4) * 8) << 6,     (((texIndex / 4) % 4) * 8 + 7) << 6, 0x11, (u8)(0xff * heightD / 2000.f), 0x13, 0xff };
