...
void generateDLPerSection(SectionData* section, int originX, int originY) {
  ...
  float offsetX = originX * 100.f;
  float offsetY = originY * 100.f;
  ...
  for (i = 0; i < SECTION_SIZE; i++) {
    for (j = 0; j < SECTION_SIZE; j++) {
      ...
      *(verts++) = (Vtx){offsetX + (i * 100) -   5, offsetY + (j * 100) -   5, heightA, 0, ((texIndex % 4) * 8) << 6,     (((texIndex / 4) % 4) * 8) << 6, 0x11, (u8)(0xff * heightA / 2000.f), 0x13, 0xff };
      *(verts++) = (Vtx){offsetX + (i * 100) + 105, offsetY + (j * 100) -   5, heightB, 0, ((texIndex % 4) * 8 + 7) << 6, (((texIndex / 4) % 4) * 8) << 6, 0x11, (u8)(0xff * heightB / 2000.f), 0x13, 0xff };
      *(verts++) = (Vtx){offsetX + (i * 100) + 105, offsetY + (j * 100) + 105, heightC, 0, ((texIndex % 4) * 8 + 7) << 6, (((texIndex / 4) % 4) * 8 + 7) << 6, 0x11, (u8)(0xff * heightC / 2000.f), 0x13, 0xff };
      *(verts++) = (Vtx){offsetX + (i * 100) -   5, offsetY + (j * 100) + 105, heightD, 0, ((texIndex % 4) * 8) << 6,     (((texIndex / 4) % 4) * 8 + 7) << 6, 0x11, (u8)(0xff * heightD / 2000.f), 0x13, 0xff };
    }
  }
...
void generateLowDetailDLPerSection(LowDetailSectionData* section, int originX, int originY) {
  int i;
  int j;
  int texIndex;
  float heightA;
  ...
  *(verts++) = (Vtx){(originX * 100.f) -   100, (originY * 100.f) -   100, heightA - 1.f, 0, ((texIndex % 4) * 8) << 6,     (((texIndex / 4) % 4) * 8) << 6, 0x11, (u8)(0xff * heightA / 2000.f), 0x13, 0xff };
  *(verts++) = (Vtx){(originX * 100.f) + 500, (originY * 100.f) -   100, heightB - 1.f, 0, ((texIndex % 4) * 8 + 7) << 6, (((texIndex / 4) % 4) * 8) << 6, 0x11, (u8)(0xff * heightB / 2000.f), 0x13, 0xff };
  *(verts++) = (Vtx){(originX * 100.f) + 500, (originY * 100.f) + 500, heightC - 1.f, 0, ((texIndex % 4) * 8 + 7) << 6, (((texIndex / 4) % 4) * 8 + 7) << 6, 0x11, (u8)(0xff * heightC / 2000.f), 0x13, 0xff };
  *(verts++) = (Vtx){(originX * 100.f) -   100, (originY * 100.f) + 500, heightD - 1.f, 0, ((texIndex % 4) * 8) << 6,     (((texIndex / 4) % 4) * 8 + 7) << 6, 0x11, (u8)(0xff * heightD / 2000.f), 0x13, 0xff };
