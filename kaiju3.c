...
static Vtx evil_octahedron_geo[] = {
  {  1,  0,  0, 0, 15 << 6, 0 << 6, 0x8C, 0x18, 0x39, 0xfc },
  { -1,  0,  0, 0, 15 << 6, 0 << 6, 0x8C, 0x18, 0x33, 0xfc },
  {  0,  1,  0, 0, 15 << 6, 15 << 6, 0x8C, 0x18, 0x39, 0xfc },
  {  0, -1,  0, 0, 15 << 6, 15 << 6, 0x8C, 0x18, 0x39, 0xfc },
...
static Gfx eva_inspired_commands[] = {
  ...
  gsSPVertex(&evil_octahedron_geo, 6, 0),
  gsSP2Triangles(0, 2, 4, 0, 0, 5, 2, 0),
  gsSP2Triangles(0, 4, 3, 0, 0, 3, 5, 0),
  gsSP2Triangles(1, 3, 4, 0, 1, 5, 3, 0),
  gsSP2Triangles(1, 4, 2, 0, 1, 2, 5, 0),
