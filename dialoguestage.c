...
DialogueLine prologueIntro9 = { "4. AIM BY HOLDING THE L\nBUTTON.", &prologueIntro10, JUST_PROTAG_THERE_BUT_NO_PEOPLE_SPEAKING };
...
DialogueLine finale07 = { "And it's so cool\nusing the simulator.", &finale09, JUST_PROTAG_THERE };
